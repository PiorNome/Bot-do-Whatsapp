...
def tarefa(client: NewClient):
    while True:
        ...
        if ((dia_da_semana == 1 and hora_atual == "15:45") or (dia_da_semana == 5 and hora_atual == "13:00") or (dia_da_semana == 6 and hora_atual == "13:00")) and not "enviado" in confirmacao_envio.read().lower():
